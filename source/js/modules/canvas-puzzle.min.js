    ...
    jigsaw.Jigsaw = Class.extend({
        ...
        resize: function resizeView() {
            var canvas = this.ce.cv,
                maxWidth = $('canvas-wrap'),
                maxHeight = $('canvas-wrap'),
                maxWidth = maxWidth.clientWidth ,
                maxHeight = maxHeight.clientHeight ;
        ...
        draw_image: function(img, w, h) {
            ...
            if (max_w > window.innerWidth || max_h > window.innerHeight - 1000) {
                var ratio = Math.min(window.innerWidth / max_w, (window.innerHeight - 1000) / max_h);
                max_w *= ratio;
                max_h *= ratio
            }
        ...
        shuffle: function() {
            ...
            var i, l = T.length,
                ...
                width = (document.documentElement.clientWidth - 1300) * pixelRatio,
                height = (document.documentElement.clientHeight - 500) * pixelRatio,
...
(function() {
    ...
    function init_events(self, eventBus) {
        ...
        Util.$("set-parts")[Cevent.isTouchDevice ? "touchstart" : "click"]("li", function(e) {
